...
class BertForPreTrainingMLMAndSSP(BertPreTrainedModel):
    ...
    def forward(
        ...
        ##TODO: Bu output'ında değişmesi gerekir mi buna da bir bakalım.
...
# Copied from Huggingface.
# See: https://github.com/huggingface/transformers/blob/c016dbdbdaf79339ae6d275d4651dc9f380be055/src/transformers/models/bert/modeling_bert.py#L640
...
# Copied from Huggingface.
# See: https://github.com/huggingface/transformers/blob/c016dbdbdaf79339ae6d275d4651dc9f380be055/src/transformers/models/bert/modeling_bert.py#L743
@dataclass
